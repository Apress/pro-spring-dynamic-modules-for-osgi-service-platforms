...
<html>
<head>
        <title>SpringSource dm Server - Pro Spring Dynamic Modules for OSGi Service Platforms </title>
...
<div id="wrap">
         <div id="header">
         <h1>SpringSource dm Server - Pro Spring Dynamic Modules for OSGi Service Platforms </h1>
         </div>
