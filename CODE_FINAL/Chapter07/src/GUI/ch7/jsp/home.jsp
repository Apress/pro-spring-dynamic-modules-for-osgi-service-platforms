...
<html>
<head>
	<title>Data Access and Bundle Management Without SpringSource dm Server - Pro Spring Dynamic Modules for OSGi Service Platforms </title>
...
<div id="wrap">
	 <div id="header">
         <h1>Data Access and Bundle Management Without SpringSource dm Server - Pro Spring Dynamic Modules for OSGi Service Platforms </h1>
         </div>
 ...
 <div id="person">
  <div style="border:red 2px dashed;margin:10px;padding:5px;"> 
   ...
   <b>Hourly Rate</b> : $<c:out value="${translator.hourlyRate}"/><br/>
	 ...
	 <div id="footer">
         <h3>Pro Spring Dynamic Modules for OSGi Service Platforms by Daniel Rubio - Published by Apress</h3>
 	 </div>
</div>
</body>
</html>
